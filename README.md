...
Featuring navigation accessibility especially for when entering numbers. The arrow key outputs give a tactile way to move around the numbers to correct mistakes on the same macropad. The tab button also allows for quick navigation.
